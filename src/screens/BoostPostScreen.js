        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: "#fff" }} >
            <View style={boostStyles.top_Header}>
                ...
                <View style={boostStyles.top_HeaderRight}>
                    <Text allowFontScaling={false} style={boostStyles.top_HeaderText}>Boost Ads & Plan options</Text>
                </View>
            ...
            <ScrollView contentContainerStyle={{ flexGrow: 1 }} showsVerticalScrollIndicator={false}>
                ...
                <View style={[boostStyles.content_view, { paddingBottom: 40 }]}>
                    ...
                    <Text allowFontScaling={false} style={boostStyles.TextWht}>Increase the reach of your audience by boosting your ads </Text>
